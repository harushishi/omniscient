  ...
  return (
    <div className="w-full max-w-sm bg-black border border-gray-500 rounded-lg shadow hover:border-white">
      ...
      <div className="flex flex-col items-center pb-10">
        <img className="w-60 h-60 mb-3 rounded-full shadow-lg" src="/YoutubeMusic.png" alt="Youtube Music" />
        <h1 className="mb-1 text-2xl font-medium text-white ">Youtube Music</h1>
